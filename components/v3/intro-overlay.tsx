 ...
 * inline boot script in the V3 layout, which sets `data-yt-intro="play"` on
...
export function IntroOverlay() {
  ...
  useEffect(() => {
    ...
    const finish = () => {
      ...
      root.style.setProperty("--v3-enter-delay", "0s");
  ...
  return (
    <div aria-hidden="true" className="v3-intro" ref={overlayRef}>
      <div className="v3-intro-veil" />
      <Image
        alt=""
        className="v3-intro-logo"
        height={288}
