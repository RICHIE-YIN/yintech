  ...
  return (
    ...
    >
      <div className="v2-console-grid">
        <Panel className="v2-console-queue" meta="Today" title="Inbound queue">
          <RecordList items={LEAD_QUEUE} />
        </Panel>

        <div className="v2-console-detail">
...
export function WebsiteVisual({ section = "Website" }: { section?: string }) {
  return (
    <figure className="v2-browser">
      <div className="v2-browser-bar">
        <span className="v2-browser-url">yourcompany.com/contact</span>
        <span className="v2-browser-tag">{section}</span>
      </div>
      <div className="v2-browser-body">
        <div className="v2-browser-page">
          <span className="v2-browser-eyebrow">Commercial Fit-Out</span>
          <strong className="v2-browser-headline">Request a quote</strong>
          <div className="v2-browser-form">
            <span>Name</span>
            <span>Company</span>
